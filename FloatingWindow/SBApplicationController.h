...
@class BKSApplicationStateMonitor, FBApplicationInfo, FBApplicationLibrary, NSDictionary, NSLock, NSMutableDictionary, NSMutableSet, NSString, SBApplicationLibraryObserver, SBApplicationRestrictionController, SBReverseCountedSemaphore,FBUIApplicationServiceDelegate,SBApplicationLifecycleObserver,SBApplicationRestrictionDataSource;
